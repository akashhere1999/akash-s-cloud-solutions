      ...
      <div className="container mx-auto px-6 relative z-10 pt-28 pb-12">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              Designing, securing, and deploying enterprise-grade cloud infrastructure
              across AWS and Azure. Leading security strategy, CI/CD pipelines, and
              multi-cloud architecture for Fortune 500 clients.
            </motion.p>
